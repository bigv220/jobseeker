        ...
        <div class="sresult-par1">
            ...
            <div class="span3">
                <div class="zoom">
                    ...
                    <?php endif;?>
                    <a href="#" class="job-btn job-btn-match"><?php echo ($jobs_match==0)?'<a href="'.$site_url.'company/joblisting">Search from "Listing Manager" to see Match%.</a>':$user["match"].'%'; ?></a>                </div>                <div>
