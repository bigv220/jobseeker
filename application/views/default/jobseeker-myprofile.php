...
<div class="view_portfolio_pop png">
    <div class="view_portfolio_pop_wrap rel">
        ...
        <div class="view_portfolio_body">
            <div class="view_portfolio_content text_style" style="display:none;">
            ...
            <div class="view_portfolio_navigator">
                <img src="<?php echo $theme_path;?>/style/btns/previous_arrow.png"/>
                <img class="current" src="<?php echo $theme_path;?>/style/portfolio/edit_txt_file_btn.png"/>
                <img src="<?php echo $theme_path;?>/style/portfolio/edit_audio_file_btn.png"/>
                <img src="<?php echo $theme_path;?>/style/portfolio/edit_audio_file_btn.png"/>
                <img src="<?php echo $theme_path;?>/style/btns/forward_arrow.png" />
            </div>
        </div>
    </div>
</div>
