    ...
    <div class="company-bd jobseeker-bd jobseeker_profile_bd">
      ...
      <div class="company-bd-left jobseeker-bd-left">
        ...
        <dl class="mb30">
          ...
          <dt>About me<a href="javascript:void(0);" class="edit_jobseeker_profile_about_me_link edit_profile_link_ajax no-underline">Edit</a></dt>
        ...
        <dl class="mb30">
          ...
          <dt>Industry<a href="javascript:void(0);" class="edit_jobseeker_profile_industry_link edit_profile_link_ajax no-underline">Edit</a></dt>
          ...
          <dl class="sresult-nav-job-dl">
              ...
              <dt>Employment History<a href="<?php echo $site_url;?>jobseeker/register#reg5" target="_blank" class="edit_jobseeker_profile_current_employment_link no-underline">Edit</a></dt>
          ...
          <?php endforeach; ?>
              ...
              <dt>Personal Skills<a href="javascript:void(0);" class="edit_jobseeker_profile_personal_skills_link edit_profile_link_ajax no-underline">Edit</a></dt>
              ...
              <dt>Technical Skills
                  ...
                  <a href="javascript:void(0);" class="edit_jobseeker_profile_technical_skills_link edit_profile_link_ajax no-underline">Edit</a>
              ...
              <dt>Language(s)<a href="javascript:void(0);" class="edit_jobseeker_profile_languages_link edit_profile_link_ajax no-underline">Edit</a></dt>
          ...
          <div class="profile_portfolios_wrapper">
              ...
              <dt>Portfolio<a href="javascript:void(0);" class="edit_jobseeker_profile_link edit_portfolio_link no-underline">Edit</a></dt>

              <div class="als-container" id="portfolio_list">

                  <span class="als-prev"><img src="<?php echo $theme_path;?>/style/btns/previous_arrow.png" alt="prev" title="previous" style="display:<?php echo (count($portfolio_projects) > 6 ? 'block':'none'); ?>"/></span>
                                      ...
                                      <a style="position:relative !important;" href="javascript:void(0);" class="portfolio_item" project-name="<?php echo $portfolio_projects[$i]['name'];?>" project-description="<?php echo $portfolio_projects[$i]['description'];?>" project-id="<?php echo $portfolio_projects[$i]['pid'];?>" file-type="<?php echo $portfolio_projects[$i]['type'];?>" file-url="<?php echo $site_url . 'attached/workExamples/500/' . $portfolio_projects[$i]['file_url'];?>">
                                          ...
                                          <?php switch($portfolio_projects[$i]['type']){
                                              ...
                                              case 1:
                                                  ...
                                                  $imgString = $site_url . "attached/workExamples/200/" .$portfolio_projects[$i]['file_url'];
                                                  
                                                  list($width, $height) = @getimagesize($imgString);
                                                  ...
                                                  if($width!="" || $height!="")
                                                  {
                                                    ...
                                                    if($tempRatio > $orgRatio)
                                                    {
                                                      $tempWidth = 80 * ($width / $height);
                                                      $left = (134 - $tempWidth) / 2;
                                                      echo "<img src='" .$imgString."' style='width:auto;height:80px;left:".$left."px'/>";
                                                    }
                                                    else
                                                    {
                                                      $tempHeight = 134 * ($height / $width);
                                                      $top = (84 - $tempHeight) / 2;
                                                       echo "<img src='" .$imgString."' style='height:auto;width:134px;top:".$top."px'/>";
                                                    }
                                                  }
                                                  else
                                                  {
                                                    echo "<img src='" .$imgString."' />";
                                                  }
                ...
                <span class="als-next"><img src="<?php echo $theme_path;?>/style/btns/forward_arrow.png" alt="next" title="next"  style="display:<?php echo (count($portfolio_projects) > 6 ? 'block':'none'); ?>"/></span> <!-- "next" button -->
      ...
      <div class="company-bd-right  jobseeker-bd-right">
          ...
          <dl class="sresult-nav-job-dl">
              ...
              <dt>Birthday<a href="javascript:void(0);" class="edit_jobseeker_profile_birthday_link no-underline">Edit</a></dt>
              ...
              <dt>Education<a href="<?php echo $site_url;?>jobseeker/register#reg4" target="_blank" class="edit_jobseeker_profile_education_link no-underline">Edit</a></dt>
              ...
              <dt>Elsewhere on Web<a href="javascript:void(0);" class="edit_jobseeker_profile_sns_link edit_profile_link_ajax no-underline">Edit</a></dt>
              ...
              <dt>Phone<a href="javascript:void(0);" class="edit_jobseeker_profile_phone_link edit_profile_link_ajax no-underline">Edit</a></dt>
...
<div class="view_portfolio_pop png">
    ...
    <div class="view_portfolio_pop_wrap rel">
        ...
        <div class="view_portfolio_header" style="height:116px;overflow:hidden;text-align: center;word-wrap: break-word;line-height: normal;">
        ...
        <div class="view_portfolio_body">
            ...
            <div class="view_portfolio_content image_style" style="display:none;height:385px;width:100%;">

                <div class="content_img" style="height:385px;width:100%;text-align:center;line-height:385px;">

                    <img src="<?php echo $theme_path;?>/style/portfolio/1.jpg" style="vertical-align: middle;"/>
                    ...
                    <div class="als-viewport">
                        ...
                        <ul class="als-wrapper">
                            ...
                            <?php for($i=0,$len=count($portfolio_projects); $i < $len; $i++):?>
                                ...
                                <li class="als-item" project-id="<?php echo $portfolio_projects[$i]['pid'];?>" project-name="<?php echo $portfolio_projects[$i]['name'];?>" project-description="<?php echo $portfolio_projects[$i]['description'];?>" file-type="<?php echo $portfolio_projects[$i]['type'];?>" file-url="<?php echo $site_url . 'attached/workExamples/500/' . $portfolio_projects[$i]['file_url'];?>">
                                    ...
                                    <?php switch($portfolio_projects[$i]['type']){
                                        ...
                                        case 1:
                                            ...
                                            if($width!="" || $height!="")
                                            {
                                              ...
                                              if($tempRatio > $orgRatio)
                                              {
                                                $tempWidth = 105 * ($width / $height);
                                                $left = (99 - $tempWidth) / 2;
                                                echo "<img src='" .$imgString."' style='width:auto;height:105px;left:".$left."px'/>";
                                              }
                                              else
                                              {
                                                $tempHeight = 99 * ($height / $width);
                                                $top = (105 - $tempHeight) / 2;
                                                 echo "<img src='" .$imgString."' style='height:auto;width:99px;top:".$top."px'/>";
                                              }
                                            }
                                            else
                                            {
    ...
    <div class="edit_portfolio_pop_wrap rel">
        ...
        <div class="edit_portfolio_pop_bd">
            ...
            <div class="add_new_portfolio">
                ...
                <div><label>Project Name:</label><input maxlength="100" name="project_name" id="project_name"/></div>

                <div><label>Project Description:</label><textarea maxlength="600" name="project_desc" id="project_desc"></textarea></div>

                <input type="hidden" name="portfolio_file_name" id="portfolio_file_name" />

                <div>

                    <button id="upload_portfolio_file_btn">Upload a project file</button>
                    <p><span>Select jpg, gif or png image with size less than 10MB.</span></p>
                    <span id="upload_portfolio_file_status_message"></span><br>
