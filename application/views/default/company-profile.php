...
<div class="company-page w770 clearfix rel">
  <div class="company-body box rel mb5">
    <div class="company-hd rel"> 
      ...
      <div class="btnarea"> <a href="<?php echo $site_url;?>company/shortlistCandidates" class="png combtn cand"></a> <a href="<?php echo $site_url;?>company/viewInterviews" class="png combtn views "></a> <a href="<?php echo $site_url;?>inbox" class="png combtn inbox"></a> <a href="<?php echo $site_url;?>company/register" class="png combtn edit"></a> </div>
    </div>
