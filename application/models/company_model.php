...
class company_model extends MY_Model {
    ...
    public function searchBookmarkedCompany($where) {
        $sql = "SELECT u.uid as company_id, first_name, description,username as name,city,profile_pic
        		FROM user as u
    ...
    public function deleteCandidate($job_id, $uid) {
        $sql = "DELETE FROM job_apply WHERE job_id=$job_id and user_id=$uid";
        return $this->db->query($sql);
    }
